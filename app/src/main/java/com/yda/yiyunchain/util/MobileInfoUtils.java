...
public class MobileInfoUtils {
    //private static MainActivity dialog_per;
    //获取手机类型
    ...
    public static void jumpStartInterface(Context context) {
        ...
        try {
            ...
            } else if (getMobileType().equals("Yulong")) { // 360手机 未测试
...
//        try {
//            dialog_per=new MainActivity();
//            dialog_per.getWindow().setType(WindowManager.LayoutParams.TYPE_TOAST);//注意这里改成吐司类
//            Log.e("HLQ_Struggle","显示弹窗");
//        } catch (Exception e) {
//            e.printStackTrace();
//            Log.e("HLQ_Struggle", "没有显示弹窗"+e.getMessage());
//            Log.e("sasssssssssssss0000", "ssssssssssssssssssss");
//        }
//    }
}
