...
public class CreateGestureActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		this.init();
		if (getIntent().getStringExtra("ignore")!=null){
			ignore_tv.setVisibility(View.VISIBLE);
		}
		else {
			ignore_tv.setVisibility(View.VISIBLE);
			ignore_tv.setText("暂不设置");
		}
	}
	 ...
	 * 重新设置手势
	 */
	@OnClick({R.id.resetBtn,R.id.ignore_tv})
	public void click(View view) {
		switch (view.getId()) {
			case R.id.resetBtn:
				...
				updateStatus(Status.DEFAULT, null);
				lockPatternView.setPattern(LockPatternView.DisplayMode.DEFAULT);break;

			case R.id.ignore_tv:
//				SharedPreferences.Editor editor = sp.edit();
//				editor.putBoolean("ignore_shoushi",true);
				Util.showIntent(CreateGestureActivity.this,MainActivity.class);
				finish();break;
		}
	}
